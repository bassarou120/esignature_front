...
const ForgetPassword = ( ) => {
    ...
    const forgetPassword =(e)=>{
        ...
        axios
            .post( process.env.REACT_APP_API_BASE_URL+'forgetpassword',
                {
                    email:email
                })
            .then(response => {
                if(response.data.success === true){
                    ...
                    $('.alert').animate({ scrollTop: 0 }, 'slow');
                }
            }).catch(error=>{
            console.log(error);
                    ...
                    <div className="authentication-inner row m-0">
                        <div className="d-none d-lg-flex col-lg-7 col-xl-8 align-items-center p-5">
                            <div className="w-100 d-flex justify-content-center">
                                <img src="assets/img/illustrations/Forgotpassword-cuate.svg" className="img-fluid"
                        ...
                        <div
                            ...
                            <div className="w-px-400 mx-auto">
                                ...
                                <p className="mb-4">
                                    Entrer votre adresse mail et nous vous enverrons les instructions nécessaires pour changer votre mot de passe</p>

                                <form id="formAuthenticationForgetPassword"
                                      className="mb-3 fv-plugins-bootstrap5 fv-plugins-framework" noValidate="novalidate" onSubmit={forgetPassword}>
                                    <div className="alert alert-success alert-dismissible d-none" role="alert">
                                        Nous avons envoyé les instructions à l'adresse mail {email}
                                    ...
                                    <div className="mb-3 fv-plugins-icon-container">
                                        ...
                                        <input type="text"
                                               ...
                                               name="email" placeholder="Enter your email" value={email} onChange={e=>setEmail(e.target.value)}
                                               autoFocus=""/>
                                    ...
                                    <button id="sbt_btn" className="btn btn-primary  w-100">
